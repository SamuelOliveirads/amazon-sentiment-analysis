...
# sentiment_analysis documentation build
...
from sentiment_analysis import __version__ as release
...
latex_documents = [
    (
        ...
        "sentiment_analysis Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "sentiment_analysis",
        "Project sentiment_analysis codebase.",
        "Data-Science",
    )
]
